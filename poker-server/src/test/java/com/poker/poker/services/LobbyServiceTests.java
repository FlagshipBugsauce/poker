...
public class LobbyServiceTests extends TestBaseClass {
  ...
  //    // Verify that the game wasn't created and there are no userId->gameId mappings for the
  // game.
  //    Assertions.assertEquals(1, activeGames.size());
  //    Assertions.assertEquals(1, userIdToGameIdMap.size());
  ...
  //   *  2) ApiSuccessModel is returned if UserDocument refers to a user that is already in the
  // game.
  ...
  //  //
  //  //    // When/Then
  //  //    // Check that join game throws a bad request exception when attempting to join with a
  // bad
  //  // ID.
