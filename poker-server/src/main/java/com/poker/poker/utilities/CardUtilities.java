...
public final class CardUtilities {
  ...
  public static final Map<CardValue, Integer> cardValues =
      ImmutableMap.<CardValue, Integer>builder()
  ...
  public static final Map<CardSuit, Integer> cardSuitValues =
      ImmutableMap.<CardSuit, Integer>builder()
          .put(CardSuit.Back, 0)
          .put(Spades, 1)
          .put(Hearts, 2)
          .put(Clubs, 3)
  ...
  public static final Map<HandType, Integer> handTypeValues =
      ImmutableMap.<HandType, Integer>builder()
          .put(StraightFlush, 8)
          .put(FourOfAKind, 7)
          .put(FullHouse, 6)
          .put(Flush, 5)
  ...
  public static Map<CardSuit, List<Card>> splitBySuit(final Collection<Card> cards) {
    ...
    for (final CardSuit suit : CardSuit.values()) {
      result.put(
          suit,
          cards.stream().filter(c -> c.getSuit() == suit).sorted(valueSorter()).collect(toList()));
    }
    return result;
  }
