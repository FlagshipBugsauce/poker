...
public final class CardUtilities {
   ...
   */
  public static final Map<CardValue, Integer> cardValues = new HashMap<CardValue, Integer>() {
    {
   ...
   */
  public static final Map<CardSuit, Integer> cardSuitValues = new HashMap<CardSuit, Integer>() {
    {
      put(CardSuit.Back, 0);
      put(Spades, 1);
      put(Hearts, 2);
   ...
   */
  public static final Map<HandType, Integer> handTypeValues = new HashMap<HandType, Integer>() {
    {
      put(StraightFlush, 8);
      put(FourOfAKind, 7);
      put(FullHouse, 6);
   ...
   * of the list.
   */
  public static final List<Evaluator> evaluators = Arrays.asList(
   ...
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   *   <li>All elements in <code>cards</code> are <code>non-null</code></li>
   *   <li>No elements have a suit or value of <code>Back</code></li>
   * </ol>
   *
   * @param cards Cards.
   ...
   * Diamonds.
   *
   * @param order Order the card should be sorted in. Should use <code>ASCENDING</code> and
   *              <code>DESCENDING</code> constants as the argument.
  ...
  public static Comparator<CardModel> lowAceValueSorter(final int order) {
    return (a, b) -> (val(a) == val(b) ?
        suitVal(a) - suitVal(b) : lowAceVal(a) - lowAceVal(b)) * order;
  }
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if there aren't 5 cards with consecutive values.</li>
   *   <li>
   *     Returns the highest 5 consecutive cards if there are 5 cards with consecutive values.
   *   </li>
   * </ol>
   *
   * @param cards Cards.
   * @return Five consecutive cards, if there are 5 consecutive cards in <code>cards</code>,
  ...
  public static List<CardModel> checkForFiveConsecutiveCards(final Collection<CardModel> cards) {
    ...
    final List<CardModel> lowAceCards = cards
        .stream()
        .map(CardModel::new)
        .sorted(lowAceValueSorter())
        .collect(Collectors.toList());
    final List<CardModel> highAceCards = cards
        .stream()
        .map(CardModel::new)
        .sorted(valueSorter())
        .collect(Collectors.toList());
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no straight flush is detected.</li>
   *   <li>Returns the best straight flush found if a straight flush is detected.</li>
   * </ol>
   *
   ...
   * accurate and predictable results, this method should only be called after the
   * <code>checkForStraightFlush</code> method has been called and has returned <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no 4-of-a-kind is detected.</li>
   *   <li>Returns the best hand with 4-of-a-kind if 4-of-a-kind is detected.</li>
   *   <li>Kicker will be in index 4 of retarded cards if 4-of-a-kind is found.</li>
   * </ol>
   *
   * @param cards Cards.
   ...
   * returned list and the pair occupying the last two indices. If no full house is found,
   * <code>null</code> is returned. When using this method to evaluate a hand, to ensure accurate
   * and predictable results, this method should only be called after the
   * <code>checkForFourOfAKind</code> method has been called and has returned <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no full house is detected.</li>
   *   <li>Returns the best full house found if a full house is detected.</li>
   *   <li>Set occupies first 3 indices of returned cards if a full house is found.</li>
   * </ol>
   *
   * @param cards Cards.
   ...
   * accurate and predictable results, this method should only be called after the
   * <code>checkForFullHouse</code> method has been called and has returned <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no flush is detected.</li>
   *   <li>Returns the best flush found if a flush is detected.</li>
   *   <li>If a flush is found, the returned flush will be in sorted order.</li>
   * </ol>
   *
   * @param cards Cards.
   ...
   * to ensure accurate and predictable results, this method should only be called after the
   * <code>checkForFlush</code> method has been called and has returned <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no straight is detected.</li>
   *   <li>Returns the best straight found if a straight is detected.</li>
   * </ol>
   *
   * @param cards Cards
   ...
   * <code>null</code> is returned. When using this method to evaluate a hand, to ensure accurate
   * and predictable results, this method should only be called after the
   * <code>checkForStraight</code> method has been called and has returned <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no set is detected.</li>
   *   <li>Returns the best set found if a set is detected.</li>
   *   <li>If a set is found, the returned set will be in sorted order.</li>
   * </ol>
   *
   * @param cards Cards.
   * @return The best flush in the cards provided if a flush is found, otherwise <code>null</code>.
   ...
   * Used in the checkForPair and checkForTwoPair methods. If there is no other pair,
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if two pairs aren't detected.</li>
   *   <li>Returns the best two pairs found if two pairs are detected.</li>
   *   <li>
   *     If two pairs are found, the highest pair will be in the first 2 indices, followed by the
   ...
   * <ol>
   *   <b>Post-Conditions:</b>
   *   <li>Returns <code>null</code> if no pair is detected.</li>
   *   <li>Returns the best pair found if a pair is detected.</li>
   *   <li>
   *     If a pair is found, the pair will be in the first two indices of the returned list,
   ...
   * called after the <code>checkForPair</code> method has been called and has returned
   * <code>null</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
  ...
  /**
   * Helper to pad certain hand types with the best possible kickers. For example, if
   * <code>result</code> contains a pair, this method will fill indices 2, 3 and 4 with the three
   * highest cards from <code>cards</code> which are not in <code>result</code>.
   *
   * <ol>
   *   <b>Pre-Conditions:</b>
   *   <li><code>cards != null</code></li>
