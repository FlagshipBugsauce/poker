...
import com.poker.poker.models.WebSocketMessageModel;
...
//  private final SimpMessagingTemplate template;
  ...
  public void getUpdate(final WebSocketUpdateModel updateModel) {
    log.debug("Sending update of type: {} to topic: {}.", updateModel.getType(), updateModel.getTopic());
    final Object data;
...
//    log.debug("{}", data.toString());
    webSocketService.sendPublicMessage(
        updateModel.getTopic(),
        new SocketContainerModel(updateModel.getType(), data));
  }
//
...
//    template.convertAndSend("/topic/" + jwt, new ApiSuccessModel("This is a custom message for " + user.getEmail()));
//  }
