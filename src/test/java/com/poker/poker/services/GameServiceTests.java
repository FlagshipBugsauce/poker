...
public class GameServiceTests extends TestBaseClass {
  ...
  public void testCreateGame_validInput() {
    ...
    final UUID userId = UUID.randomUUID();
    // When/Then
    final ApiSuccessModel response = gameService.createGame(getSampleCreateGameModel(), userId);
  ...
  public void testGetGameList() {
    ...
    Assertions.assertEquals(getSampleGameDocument().getMaxPlayers(), games.get(0).getMaxPlayers());
